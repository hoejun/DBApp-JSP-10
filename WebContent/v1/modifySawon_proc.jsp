...
<%
	...
	String sql = "update tblSawon set id='" + s_id +"',name='" +s_name+ "',"+
				"pass='" + s_pw +"', age="+s_age+", addr='" + s_addr+"', extension='"+
				s_extension + "',dept='" + s_dept + "'where no= "+ no;
	...
	try{
	    ...
	    //3단계 DB에 updqte쿼리 전달 및 updqte쿼리를 실행할 Statement객체 반환
	    stmt = con.createStatement();
	    
	    //4단계 DB에 update 쿼리 실행하고 끝낸다.
